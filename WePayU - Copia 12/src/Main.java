...
//QUAL DOS  DE BACKUPS Q TÁ ESSE TRECOOOOO AA
// Press Shift twice to open the Search Everywhere dialog and type `show whitespaces`,
// then press Enter. You can now see whitespace characters in your code.
// ai mds socorro esse xml vai me matar
        ...
        String facade = "br.ufal.ic.p2.wepayu.Facade";
         ...
         EasyAccept.main(new String[]{facade, "tests/us1_1.txt"});
          EasyAccept.main(new String[]{facade, "tests/us2.txt"});
           ...
           EasyAccept.main(new String[]{facade, "tests/us3_1.txt"});  //todo bugado esse
 //          EasyAccept.main(new String[]{facade, "tests/us4.txt"});
 //         EasyAccept.main(new String[]{facade, "tests/us4_1.txt"});     //estranho também
//
